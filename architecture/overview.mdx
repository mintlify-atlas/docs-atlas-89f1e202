---
title: "VOZI Architecture: App Structure and State Management"
sidebarTitle: "Overview"
description: "How VOZI is structured — the scope tree, ChangeNotifier stores, named routes, and the local-first data strategy with optional Supabase sync."
---
