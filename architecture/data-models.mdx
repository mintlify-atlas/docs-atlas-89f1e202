...
description: "Reference for all core Dart data models in VOZI — ChildProfile, Phoneme, PracticeWord, SpeechAttempt, WordResult, and their serialization for local storage and Supabase sync."
---
